#=========================================================================
# VCGRATemplateRTL__940b289cd301d542_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__940b289cd301d542
#-------------------------------------------------------------------------

class CGRATemplateRTL__940b289cd301d542( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__940b289cd301d542_v.so', os.path.getmtime( './libCGRATemplateRTL__940b289cd301d542_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__940b289cd301d542_v.so')

    # increment instance count
    CGRATemplateRTL__940b289cd301d542.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__940b289cd301d542.verilator1.vcd"
