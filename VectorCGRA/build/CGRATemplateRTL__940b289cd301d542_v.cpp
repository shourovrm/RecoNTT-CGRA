//========================================================================
// VCGRATemplateRTL__940b289cd301d542_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__940b289cd301d542/VCGRATemplateRTL__940b289cd301d542.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__940b289cd301d542/VCGRATemplateRTL__940b289cd301d542__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__940b289cd301d542_t;

  // Exposed methods
  VCGRATemplateRTL__940b289cd301d542_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__940b289cd301d542_t *);
  void eval( VCGRATemplateRTL__940b289cd301d542_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__940b289cd301d542_t *, char * );
  #endif
...
VCGRATemplateRTL__940b289cd301d542_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__940b289cd301d542_t * m;
  VCGRATemplateRTL__940b289cd301d542   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__940b289cd301d542_t *) malloc( sizeof(VCGRATemplateRTL__940b289cd301d542_t) );
  model = new VCGRATemplateRTL__940b289cd301d542();
...
void destroy_model( VCGRATemplateRTL__940b289cd301d542_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__940b289cd301d542 * model = (VCGRATemplateRTL__940b289cd301d542 *) m->model;
...
void eval( VCGRATemplateRTL__940b289cd301d542_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__940b289cd301d542_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__940b289cd301d542__v );
