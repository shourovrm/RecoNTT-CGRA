//========================================================================
// VCGRATemplateRTL__da2b54794587890b_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__da2b54794587890b/VCGRATemplateRTL__da2b54794587890b.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__da2b54794587890b/VCGRATemplateRTL__da2b54794587890b__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__da2b54794587890b_t;

  // Exposed methods
  VCGRATemplateRTL__da2b54794587890b_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__da2b54794587890b_t *);
  void eval( VCGRATemplateRTL__da2b54794587890b_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__da2b54794587890b_t *, char * );
  #endif
...
VCGRATemplateRTL__da2b54794587890b_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__da2b54794587890b_t * m;
  VCGRATemplateRTL__da2b54794587890b   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__da2b54794587890b_t *) malloc( sizeof(VCGRATemplateRTL__da2b54794587890b_t) );
  model = new VCGRATemplateRTL__da2b54794587890b();
...
void destroy_model( VCGRATemplateRTL__da2b54794587890b_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__da2b54794587890b * model = (VCGRATemplateRTL__da2b54794587890b *) m->model;
...
void eval( VCGRATemplateRTL__da2b54794587890b_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__da2b54794587890b_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__da2b54794587890b__v );
