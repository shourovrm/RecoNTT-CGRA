#=========================================================================
# VCGRATemplateRTL__da2b54794587890b_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__da2b54794587890b
#-------------------------------------------------------------------------

class CGRATemplateRTL__da2b54794587890b( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__da2b54794587890b_v.so', os.path.getmtime( './libCGRATemplateRTL__da2b54794587890b_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__da2b54794587890b_v.so')

    # increment instance count
    CGRATemplateRTL__da2b54794587890b.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__da2b54794587890b.verilator1.vcd"
