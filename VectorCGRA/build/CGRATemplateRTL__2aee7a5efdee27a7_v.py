#=========================================================================
# VCGRATemplateRTL__2aee7a5efdee27a7_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__2aee7a5efdee27a7
#-------------------------------------------------------------------------

class CGRATemplateRTL__2aee7a5efdee27a7( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__2aee7a5efdee27a7_v.so', os.path.getmtime( './libCGRATemplateRTL__2aee7a5efdee27a7_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__2aee7a5efdee27a7_v.so')

    # increment instance count
    CGRATemplateRTL__2aee7a5efdee27a7.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__2aee7a5efdee27a7.verilator1.vcd"
