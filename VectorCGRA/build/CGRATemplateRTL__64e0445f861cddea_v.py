#=========================================================================
# VCGRATemplateRTL__64e0445f861cddea_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__64e0445f861cddea
#-------------------------------------------------------------------------

class CGRATemplateRTL__64e0445f861cddea( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__64e0445f861cddea_v.so', os.path.getmtime( './libCGRATemplateRTL__64e0445f861cddea_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__64e0445f861cddea_v.so')

    # increment instance count
    CGRATemplateRTL__64e0445f861cddea.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__64e0445f861cddea.verilator1.vcd"
