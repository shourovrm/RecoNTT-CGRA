//========================================================================
// VCGRATemplateRTL__64e0445f861cddea_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__64e0445f861cddea/VCGRATemplateRTL__64e0445f861cddea.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__64e0445f861cddea/VCGRATemplateRTL__64e0445f861cddea__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__64e0445f861cddea_t;

  // Exposed methods
  VCGRATemplateRTL__64e0445f861cddea_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__64e0445f861cddea_t *);
  void eval( VCGRATemplateRTL__64e0445f861cddea_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__64e0445f861cddea_t *, char * );
  #endif
...
VCGRATemplateRTL__64e0445f861cddea_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__64e0445f861cddea_t * m;
  VCGRATemplateRTL__64e0445f861cddea   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__64e0445f861cddea_t *) malloc( sizeof(VCGRATemplateRTL__64e0445f861cddea_t) );
  model = new VCGRATemplateRTL__64e0445f861cddea();
...
void destroy_model( VCGRATemplateRTL__64e0445f861cddea_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__64e0445f861cddea * model = (VCGRATemplateRTL__64e0445f861cddea *) m->model;
...
void eval( VCGRATemplateRTL__64e0445f861cddea_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__64e0445f861cddea_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__64e0445f861cddea__v );
