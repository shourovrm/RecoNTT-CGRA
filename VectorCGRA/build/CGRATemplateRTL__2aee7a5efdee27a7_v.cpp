//========================================================================
// VCGRATemplateRTL__2aee7a5efdee27a7_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__2aee7a5efdee27a7/VCGRATemplateRTL__2aee7a5efdee27a7.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__2aee7a5efdee27a7/VCGRATemplateRTL__2aee7a5efdee27a7__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__2aee7a5efdee27a7_t;

  // Exposed methods
  VCGRATemplateRTL__2aee7a5efdee27a7_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__2aee7a5efdee27a7_t *);
  void eval( VCGRATemplateRTL__2aee7a5efdee27a7_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__2aee7a5efdee27a7_t *, char * );
  #endif
...
VCGRATemplateRTL__2aee7a5efdee27a7_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__2aee7a5efdee27a7_t * m;
  VCGRATemplateRTL__2aee7a5efdee27a7   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__2aee7a5efdee27a7_t *) malloc( sizeof(VCGRATemplateRTL__2aee7a5efdee27a7_t) );
  model = new VCGRATemplateRTL__2aee7a5efdee27a7();
...
void destroy_model( VCGRATemplateRTL__2aee7a5efdee27a7_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__2aee7a5efdee27a7 * model = (VCGRATemplateRTL__2aee7a5efdee27a7 *) m->model;
...
void eval( VCGRATemplateRTL__2aee7a5efdee27a7_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__2aee7a5efdee27a7_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__2aee7a5efdee27a7__v );
