#=========================================================================
# VCGRATemplateRTL__f92d8c67ac8001c7_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__f92d8c67ac8001c7
#-------------------------------------------------------------------------

class CGRATemplateRTL__f92d8c67ac8001c7( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__f92d8c67ac8001c7_v.so', os.path.getmtime( './libCGRATemplateRTL__f92d8c67ac8001c7_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__f92d8c67ac8001c7_v.so')

    # increment instance count
    CGRATemplateRTL__f92d8c67ac8001c7.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__f92d8c67ac8001c7.verilator1.vcd"
