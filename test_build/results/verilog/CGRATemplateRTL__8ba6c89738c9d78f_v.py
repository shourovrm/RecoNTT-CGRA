#=========================================================================
# VCGRATemplateRTL__8ba6c89738c9d78f_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__8ba6c89738c9d78f
#-------------------------------------------------------------------------

class CGRATemplateRTL__8ba6c89738c9d78f( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__8ba6c89738c9d78f_v.so', os.path.getmtime( './libCGRATemplateRTL__8ba6c89738c9d78f_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__8ba6c89738c9d78f_v.so')

    # increment instance count
    CGRATemplateRTL__8ba6c89738c9d78f.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__8ba6c89738c9d78f.verilator1.vcd"
