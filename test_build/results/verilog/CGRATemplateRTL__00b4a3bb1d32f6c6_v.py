#=========================================================================
# VCGRATemplateRTL__00b4a3bb1d32f6c6_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__00b4a3bb1d32f6c6
#-------------------------------------------------------------------------

class CGRATemplateRTL__00b4a3bb1d32f6c6( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__00b4a3bb1d32f6c6_v.so', os.path.getmtime( './libCGRATemplateRTL__00b4a3bb1d32f6c6_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__00b4a3bb1d32f6c6_v.so')

    # increment instance count
    CGRATemplateRTL__00b4a3bb1d32f6c6.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__00b4a3bb1d32f6c6.verilator1.vcd"
