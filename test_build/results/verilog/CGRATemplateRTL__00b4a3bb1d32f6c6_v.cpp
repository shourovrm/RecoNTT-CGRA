//========================================================================
// VCGRATemplateRTL__00b4a3bb1d32f6c6_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__00b4a3bb1d32f6c6/VCGRATemplateRTL__00b4a3bb1d32f6c6.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__00b4a3bb1d32f6c6/VCGRATemplateRTL__00b4a3bb1d32f6c6__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__00b4a3bb1d32f6c6_t;

  // Exposed methods
  VCGRATemplateRTL__00b4a3bb1d32f6c6_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__00b4a3bb1d32f6c6_t *);
  void eval( VCGRATemplateRTL__00b4a3bb1d32f6c6_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__00b4a3bb1d32f6c6_t *, char * );
  #endif
...
VCGRATemplateRTL__00b4a3bb1d32f6c6_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__00b4a3bb1d32f6c6_t * m;
  VCGRATemplateRTL__00b4a3bb1d32f6c6   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__00b4a3bb1d32f6c6_t *) malloc( sizeof(VCGRATemplateRTL__00b4a3bb1d32f6c6_t) );
  model = new VCGRATemplateRTL__00b4a3bb1d32f6c6();
...
void destroy_model( VCGRATemplateRTL__00b4a3bb1d32f6c6_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__00b4a3bb1d32f6c6 * model = (VCGRATemplateRTL__00b4a3bb1d32f6c6 *) m->model;
...
void eval( VCGRATemplateRTL__00b4a3bb1d32f6c6_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__00b4a3bb1d32f6c6_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__00b4a3bb1d32f6c6__v );
