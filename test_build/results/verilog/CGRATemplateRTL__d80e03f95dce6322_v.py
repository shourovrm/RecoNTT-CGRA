#=========================================================================
# VCGRATemplateRTL__d80e03f95dce6322_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__d80e03f95dce6322
#-------------------------------------------------------------------------

class CGRATemplateRTL__d80e03f95dce6322( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__d80e03f95dce6322_v.so', os.path.getmtime( './libCGRATemplateRTL__d80e03f95dce6322_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__d80e03f95dce6322_v.so')

    # increment instance count
    CGRATemplateRTL__d80e03f95dce6322.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__d80e03f95dce6322.verilator1.vcd"
