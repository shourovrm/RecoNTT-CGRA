//========================================================================
// VCGRATemplateRTL__66994df26e00eec2_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__66994df26e00eec2/VCGRATemplateRTL__66994df26e00eec2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__66994df26e00eec2/VCGRATemplateRTL__66994df26e00eec2__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__66994df26e00eec2_t;

  // Exposed methods
  VCGRATemplateRTL__66994df26e00eec2_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__66994df26e00eec2_t *);
  void eval( VCGRATemplateRTL__66994df26e00eec2_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__66994df26e00eec2_t *, char * );
  #endif
...
VCGRATemplateRTL__66994df26e00eec2_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__66994df26e00eec2_t * m;
  VCGRATemplateRTL__66994df26e00eec2   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__66994df26e00eec2_t *) malloc( sizeof(VCGRATemplateRTL__66994df26e00eec2_t) );
  model = new VCGRATemplateRTL__66994df26e00eec2();
...
void destroy_model( VCGRATemplateRTL__66994df26e00eec2_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__66994df26e00eec2 * model = (VCGRATemplateRTL__66994df26e00eec2 *) m->model;
...
void eval( VCGRATemplateRTL__66994df26e00eec2_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__66994df26e00eec2_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__66994df26e00eec2__v );
