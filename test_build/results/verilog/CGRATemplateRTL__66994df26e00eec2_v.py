#=========================================================================
# VCGRATemplateRTL__66994df26e00eec2_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CGRATemplateRTL__66994df26e00eec2
#-------------------------------------------------------------------------

class CGRATemplateRTL__66994df26e00eec2( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libCGRATemplateRTL__66994df26e00eec2_v.so', os.path.getmtime( './libCGRATemplateRTL__66994df26e00eec2_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libCGRATemplateRTL__66994df26e00eec2_v.so')

    # increment instance count
    CGRATemplateRTL__66994df26e00eec2.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "CGRATemplateRTL__66994df26e00eec2.verilator1.vcd"
