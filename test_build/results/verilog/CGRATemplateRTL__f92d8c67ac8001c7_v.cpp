//========================================================================
// VCGRATemplateRTL__f92d8c67ac8001c7_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__f92d8c67ac8001c7/VCGRATemplateRTL__f92d8c67ac8001c7.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__f92d8c67ac8001c7/VCGRATemplateRTL__f92d8c67ac8001c7__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCGRATemplateRTL__f92d8c67ac8001c7_t;

  // Exposed methods
  VCGRATemplateRTL__f92d8c67ac8001c7_t * create_model( const char * );
  void destroy_model( VCGRATemplateRTL__f92d8c67ac8001c7_t *);
  void eval( VCGRATemplateRTL__f92d8c67ac8001c7_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VCGRATemplateRTL__f92d8c67ac8001c7_t *, char * );
  #endif
...
VCGRATemplateRTL__f92d8c67ac8001c7_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__f92d8c67ac8001c7_t * m;
  VCGRATemplateRTL__f92d8c67ac8001c7   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__f92d8c67ac8001c7_t *) malloc( sizeof(VCGRATemplateRTL__f92d8c67ac8001c7_t) );
  model = new VCGRATemplateRTL__f92d8c67ac8001c7();
...
void destroy_model( VCGRATemplateRTL__f92d8c67ac8001c7_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__f92d8c67ac8001c7 * model = (VCGRATemplateRTL__f92d8c67ac8001c7 *) m->model;
...
void eval( VCGRATemplateRTL__f92d8c67ac8001c7_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__f92d8c67ac8001c7_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__f92d8c67ac8001c7__v );
