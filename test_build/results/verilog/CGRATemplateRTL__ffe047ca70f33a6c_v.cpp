//========================================================================
// VCGRATemplateRTL__ffe047ca70f33a6c_v.cpp
//========================================================================
...
#include "obj_dir_CGRATemplateRTL__ffe047ca70f33a6c/VCGRATemplateRTL__ffe047ca70f33a6c.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CGRATemplateRTL__ffe047ca70f33a6c/VCGRATemplateRTL__ffe047ca70f33a6c__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VCGRATemplateRTL__ffe047ca70f33a6c_t *, char * );
  #endif
...
VCGRATemplateRTL__ffe047ca70f33a6c_t * create_model( const char *vcd_filename ) {

  VCGRATemplateRTL__ffe047ca70f33a6c_t * m;
  VCGRATemplateRTL__ffe047ca70f33a6c   * model;

  Verilated::randReset( 0 );

  m     = (VCGRATemplateRTL__ffe047ca70f33a6c_t *) malloc( sizeof(VCGRATemplateRTL__ffe047ca70f33a6c_t) );
  model = new VCGRATemplateRTL__ffe047ca70f33a6c();
...
void destroy_model( VCGRATemplateRTL__ffe047ca70f33a6c_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCGRATemplateRTL__ffe047ca70f33a6c * model = (VCGRATemplateRTL__ffe047ca70f33a6c *) m->model;
...
void eval( VCGRATemplateRTL__ffe047ca70f33a6c_t * m ) {
...
#if VLINETRACE
void trace( VCGRATemplateRTL__ffe047ca70f33a6c_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_CGRATemplateRTL__ffe047ca70f33a6c__v );
